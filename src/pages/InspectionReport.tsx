...
const InspectionForm = () => {
  ...
  {
    name: "Seatbelt",
    svg: `<svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#888780"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <style type="text/css"> .st0{fill:#888780;} </style> <g> <path class="st0" d="M256.626,107.829c29.788,0,53.919-24.132,53.919-53.91C310.545,24.14,286.414,0,256.626,0 c-29.769,0-53.91,24.14-53.91,53.919C202.716,83.698,226.857,107.829,256.626,107.829z"></path> <path class="st0" d="M332.771,322.408c-5.62-8.571-6.909-12.43-8.134-20.6H188.635c-1.226,8.171-2.515,12.03-8.134,20.6 c-7.799,11.884-17.115,23.831-22.08,31.522c-14.327,22.179-15.253,37.432-4.722,61.5c14.309,32.693,35.69,79.413,35.69,79.413 c8.38,19.664,25.166,19.556,35.253,13.782c10.459-5.982,14.036-20.191,7.771-33.129c-6.264-12.928-29.06-78.396-29.06-78.396 s10.74-15.324,24.839-33.655c9.297-12.084,20.618-17.123,28.444-17.123c7.826,0,19.148,5.039,28.444,17.123 c14.099,18.33,24.84,33.655,24.84,33.655s-22.798,65.468-29.062,78.396c-6.264,12.938-2.688,27.146,7.771,33.129 c10.087,5.774,26.873,5.883,35.253-13.782c0,0,21.38-46.72,35.689-79.413c10.531-24.068,9.605-39.32-4.721-61.5 C349.885,346.239,340.569,334.292,332.771,322.408z"></path> <path class="st0" d="M190.659,227.144l118.697-95.473c-5.275-2.924-11.248-4.513-17.404-4.513h-35.316h-35.316 c-9.986,0-23.405,4.803-29.216,15.842c-2.216,4.203-6.392,14.526-6.392,14.526s-21.036,56.942-75.073,126.087 c-29.197,37.36,3.486,55.2,19.756,42.416c24.522-19.266,62.172-72.05,62.172-72.05L190.659,227.144z"></path> <path class="st0" d="M401.361,283.614c-54.037-69.144-73.612-123.327-73.612-123.327L193.873,267.98h126.46l0.844-11.585 c7.663,10.522,39.039,52.83,60.429,69.634C397.875,338.813,430.559,320.974,401.361,283.614z"></path> </g> </g></svg>`
  },
  {
    name: "Oil Lamp",
    svg: `<svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    name: "Brake Light",
    svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 10V11.5M12 14H12.01M19.5 7.02344C20.4478 8.4489 21 10.16 21 12.0001C21 13.8402 20.4478 15.5514 19.5 16.9768M4.5 7.02344C3.55223 8.4489 3 10.16 3 12.0001C3 13.8402 3.55223 15.5514 4.5 16.9768M17 12C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7C14.7614 7 17 9.23858 17 12Z" stroke="#888780" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`
  },
  {
    name: "Coolant Temp",
    svg: `<svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
